...
(def trials
  [{:sample [:micro :A1] :cue [:micro :B1_left] :seq [:micro :B1_left] :op op-left :term term-op-left :label :a1-b1-left}
   {:sample [:micro :A2] :cue [:micro :B2_right] :seq [:micro :B2_right] :op op-right :term term-op-right :label :a2-b2-right}])
